...
urlpatterns = [
    ...
    path('competitions/', views.competitions_base, name='competitions_base'),
    path('competitions/announce/', views.competitions_page, name='competitions_page'),
    ...
    path('competitions/<str:comp_id>/', views.edit_comp, name='edit_comp'),
    ...
    path('schools/students/<int:student_id>/edit', views.edit_school_student, name='edit_school_student'),
